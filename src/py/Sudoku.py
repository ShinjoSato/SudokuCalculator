...
if __name__ == "__main__":
    ...
    #Question 199 extends
    matrix=[
        [ 0, 0,15, 2,   12, 7,16, 0,    0, 4,10, 5,   14, 8, 0, 0],
        [ 0, 0, 4, 0,    0, 0, 3,10,   14,15, 0, 0,    0, 7, 0, 0],
        [14, 6, 5, 0,    0, 1, 8, 0,    0,13, 2, 0,    0,15,10,11],
        [ 7, 0, 0, 3,   11, 0, 2, 0,    0,16, 0, 1,   12, 0, 0, 5],

        [ 4, 0, 0,10,    2, 0,12,11,   13, 3, 0, 9,   15, 0, 0, 8],
        [13, 0, 3, 0,    0,15, 0, 1,    4, 0, 5, 0,    0, 2, 0,10],
        [ 1, 5,11,14,   16, 0, 0, 4,   10, 0, 0,12,    7,13, 9, 3],
        [ 0,15, 0, 0,   10, 3,13, 7,   11, 1,16, 8,    0, 0, 5, 0],

        [0, 1, 0, 0,    15, 2, 4,14,    5, 9, 3,13,    0, 0, 8, 0],
        [15, 8,14,13,    3, 0, 0,12,    1, 0, 0,10,    2, 5, 7, 9],
        [ 3, 0,10, 0,    0,13, 0, 5,   15, 0,11, 0,    0,12, 0,16],
        [ 9, 0, 0, 5,    6, 0, 1, 8,   16,12, 0, 14,  13, 0, 0, 4],

        [ 6, 0, 0, 4,    1, 0,15, 0,    0,14, 0, 3,    5, 0, 0, 7],
        [16, 2, 7, 0,    0,11, 5, 0,    0,10,13, 0,    0, 1, 3,15],
        [ 0, 0, 8, 0,    0, 0,10, 3,    7,11, 0, 0,    0, 4, 0, 0],
        [ 0, 0, 1,11,    8, 4, 7, 0,    0, 5,12,15,    9,14, 0, 0]
    ]
